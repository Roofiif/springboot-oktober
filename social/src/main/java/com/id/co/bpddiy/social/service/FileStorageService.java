...
import com.id.co.bpddiy.social.exception.FileStorageException;
import com.id.co.bpddiy.social.exception.InvalidFileException;
import com.id.co.bpddiy.social.exception.ResourceNotFoundException;
...
public class FileStorageService {
    ...
    private boolean isValidExtension(String extension) {
        ...
        String[] alloedExts = allowedExtensions.split(",");
        return Arrays.stream(alloedExts)
