...
public class Kasir {
    public static void main(String[] args) {
        ...
        daftarProduk.add(new Produk("Jengkol", 3000, 10));
        daftarProduk.add(new Produk("Tempe", 4000, 10));
        daftarProduk.add(new Produk("Ayam", 2000, 10));
        ...
        while (belanja) {
            ...
            //instruksi
            System.out.println("\nMasukkan nama produk (atau klik 'selesai'): ");
